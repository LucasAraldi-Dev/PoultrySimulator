...
export const FEEDS: Record<string, FeedItem> = {
  ...
  'feed_layers_pre': {
    id: 'feed_layers_pre',
    name: 'Pré Inicial Postura (0-1 sem)',
    costPerKg: 3.0,
    requiredLevel: 1,
    bonus: { mortalityModifier: 1.0, growthModifier: 1.0, eggModifier: 1.0 },
  },
  ...
  'feed_layers_grow': {
    id: 'feed_layers_grow',
    name: 'Cresc. Postura (5-15 sem)',
    costPerKg: 1.6,
    requiredLevel: 1,
    bonus: { mortalityModifier: 1.0, growthModifier: 1.0, eggModifier: 1.0 },
  },
  'feed_layers_pre_lay': {
    id: 'feed_layers_pre_lay',
    name: 'Pré Postura (16-21 sem)',
    costPerKg: 1.9,
    requiredLevel: 1,
    bonus: { mortalityModifier: 1.0, growthModifier: 1.0, eggModifier: 1.0 },
  },
